          ...
          <Container fluid className="container-fluid-custom">
            <Row>
              <Col md={6} className="landing-page-image">
                {/* Bagian kiri (gambar) */}
                <img src={gambarhp} alt="Gambar Anda" className="img-fluids" />
              </Col>
              <Col md={6} className="landing-page-text">
                {/* Bagian kanan (teks) */}
                <div>
                  <h2 className="tagline">
                    All The <span style={{ color: "#6379F4" }}>Great </span>{" "}
                    Zwallet Features
                  </h2>
                </div>
                ...
                <Card>
                  <Card.Body>
                    <Card.Title>
                      <span style={{ color: "#6379F4" }}>2. </span> Data Secured
                    </Card.Title>
                    <Card.Text>
                ...
                <Card>
                  <Card.Body>
                    <Card.Title>
                      <span style={{ color: "#6379F4" }}>3. </span> User
                      Friendly
                    </Card.Title>
                    <Card.Text>
